  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.graphics}>
        <Image src="/helium.png" alt="Helium logo" width={200} height={200} />
        <Image src="/phantom.png" alt="Phantom logo" width={200} height={200} />
        <Image src="/solana.png" alt="Solana logo" width={200} height={200} />
        <Image src="/usdc.svg" alt="USDC logo" width={200} height={200} />
      </div>
      <p>
